# Weekly Research Intelligence — 2026-01-30
...
- Relevance: IGNORE (no-LLM fallback)

**Why**
- Wire an LLM to generate project-specific rationale/actions.

**Direct actions (30d)**
- Add tags/notes to items.yaml to improve specificity.

**Creative mode**
- Enable LLM to propose creative ideas.

### github: facebookresearch/esm

- Notes: ESM protein language models; check updates relevant to embedding extraction / scoring.

- Relevance: HIGH (no-LLM fallback)
...
- Relevance: MEDIUM (no-LLM fallback)
...
### slides: JPM Healthcare 2026 – Company X deck

- URL: https://...

- Notes: Track modality/platform claims; extract comparable metrics vs our pipeline needs.
